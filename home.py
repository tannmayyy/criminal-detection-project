...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file="C:\\Users\\HP\\Desktop\\final year project\\Criminal-Identification-System-master-master\\back.png")
...
def selectMultiImage(opt_menu, menu_var):
    ...
    if(len(path_list) < 5):
        ...
        back_img = tk.PhotoImage(file="C:\\Users\\HP\\Desktop\\final year project\\Criminal-Identification-System-master-master\\previous.png")
        next_img = tk.PhotoImage(file="C:\\Users\\HP\\Desktop\\final year project\\Criminal-Identification-System-master-master\\next.png")
...
class VideoFaceDetector:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Video Face Detector")
    ...
    def open_file(self):
        self.filename = filedialog.askopenfilename(title="Select a video file", filetypes=[("Video files", "*.avi *.mp4")])
        if self.filename:
            self.detect_faces()
...
def getPage2():
    ...
    tk.Button(btn_grid, text="Select Video File", command=VideoFaceDetector,
                   font="Arial 15 bold", bg="#2196f3", fg="white",
                   pady=10, bd=0, highlightthickness=0,
                   activebackground="#091428", activeforeground="white").grid(row=1, column=1, padx=25, pady=25)
...
def getPage3():
    ...
    basicPageSetup(3)
    heading.configure(text="CCTV Surveillance")
    right_frame.configure(text="Detected Criminals")
...
logo = tk.PhotoImage("C:\\Users\\HP\\Desktop\\final year project\\Criminal-Identification-System-master-master\\logo.jpg")
